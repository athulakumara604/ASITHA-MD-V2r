...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? '𝙰𝚂𝙸𝚃𝙷𝙰-𝙼𝙳=Lywg1RID#Vq7lF01AVJnAtl3cn7vGZPEhmqSK5I043Y1DYKA8cjI' : process.env.SESSION_ID,
PREFIX: process.env.PREFIX || '.' ,
PREFIX: process.env.PORT || '8001' 
